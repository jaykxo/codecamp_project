...
const Detail = () => {
    ...
    return (
        <div className='D_layout'>
            <div className="D_enroll-row-container">
                <div className='D_title'>
                    <div className='D_title-text'>
                        살어리 살어리랏다 쳥산(靑山)애 살어리랏다멀위랑 ᄃᆞ래랑 먹고 쳥산(靑山)애 살어리랏다얄리얄리 얄랑셩 얄라리 얄라
                    </div>
                <div className='D_info'>
                    <div className='D_info-1'>
                        <div className='D_info-1-profile'>
